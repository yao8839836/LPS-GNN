...
DEFAULT_LOCAL_TRAIN_PATH = '/dockerdata/sns/train'
DEFAULT_LOCAL_TEST_PATH = '/dockerdata/sns/test'
DEFAULT_LOCAL_MODEL_PATH = '/dockerdata/sns/model'
DEFAULT_LOCAL_DATA_PATH = '/dockerdata/sns/data'
